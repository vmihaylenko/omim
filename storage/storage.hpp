...
private:
  ...
  diff_scheme::Manager m_diffManager;
  ...
  using DownloadedFilesProcessingFn = function<void(TCountryId const & countryId, bool isSuccess)>;
...
private:
  ...
  bool ApplyDiff(TCountryId const & countryId);
};
