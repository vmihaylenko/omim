...
vector<EditableMapObject::TLocalizedStreet> const & EditableMapObject::GetNearbyStreets() const { return m_nearbyStreets; }
...
void EditableMapObject::SetStreet(EditableMapObject::TLocalizedStreet const & street) { m_street = street; }

void EditableMapObject::SetNearbyStreets(vector<EditableMapObject::TLocalizedStreet> && streets)
{
...
EditableMapObject::TLocalizedStreet const & EditableMapObject::GetStreet() const { return m_street; }
